...
const testimonials: Testimonial[] = [
  {
    id: 1,
    quote: "Droisys transformed our digital infrastructure with their AI-powered solutions. The results exceeded our expectations, delivering 40% improvement in operational efficiency.",
    name: "Sarah Johnson",
    title: "CTO",
  ...
  {
    id: 2,
    quote: "Their consultative approach and deep industry expertise helped us navigate complex digital transformation challenges. Outstanding results delivered on time.",
    name: "Michael Chen",
  ...
  {
    id: 3,
    quote: "The web applications developed by Droisys have revolutionized our business operations. We now have faster, more efficient digital processes.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl text-gray-600">
            See how we've helped organizations across industries achieve measurable results through innovative technology solutions.
          </p>
        </div>
                ...
                <CardContent className="p-8 md:p-12">
                  <div className="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="md:w-2/3 text-center md:text-left">
                      ...
                      <h4 className="text-xl font-bold mb-1 text-gray-900">{testimonials[activeIndex].name}</h4>
