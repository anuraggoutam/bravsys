...
const projects: Project[] = [
  {
    ...
    description: 'A complete redesign of an eco-friendly marketplace that increased conversions by 45%.'
  },
  {
    id: 2,
    ...
    category: 'Web App',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200',
    description: 'Interactive finance dashboard with real-time data visualization.'
  },
  {
    id: 3,
    ...
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200',
    description: 'Responsive website for a luxury resort with booking functionality.'
  },
  {
    id: 4,
    ...
    category: 'Mobile App',
    image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200',
    description: 'Mobile application for fitness tracking with personalized workout plans.'
  },
  {
    id: 5,
...
const categories = ['All', 'E-commerce', 'Web App', 'Mobile App', 'Branding', 'Hospitality'];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="hidden md:flex justify-center mb-12 space-x-4">
          {categories.map(category => (
            <Button
              key={category}
              variant={activeCategory === category ? "default" : "outline-solid"}
