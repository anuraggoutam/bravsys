        ...
        <div className="bg-linear-to-r from-primary to-blue-600 rounded-3xl p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Partner with us to unlock your business potential. Our expert team is ready to deliver 
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Button 
                variant="outline"
                size="lg"
                className="border-2 border-white/30 hover:border-white/50 hover:bg-white/10 text-white px-8 py-4 rounded-xl transition-all duration-300"
              >
          ...
          <div className="relative z-10">
            <div className="relative">
              ...
              <img 
                src="/lovable-uploads/77bcef79-79c7-400e-8893-48a86e18f5bb.png" 
