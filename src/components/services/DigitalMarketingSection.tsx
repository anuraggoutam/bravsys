  ...
  const services = [
    {
      ...
      description:
        'Boost your online visibility and drive organic traffic with our comprehensive SEO strategies tailored to your business goals.',
    ...
    },
    {
      ...
      description:
        'Engage your audience and build brand awareness across all major social media platforms with targeted campaigns.',
    ...
    },
    {
      ...
      description:
        'Make data-driven decisions with comprehensive analytics and reporting to optimize your digital marketing performance.',
    ...
    },
    {
      ...
      description:
        'Maximize ROI with strategic PPC campaigns across Google Ads, Facebook, and other advertising platforms.',
    ...
    },
    {
      ...
      description:
        'Reach customers on-the-go with mobile-optimized campaigns and app marketing strategies for maximum engagement.',
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            ...
            your growth and maximize your online presence with measurable
            results
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <CardHeader className="pb-6 relative z-10">
                <div
                  className={`service-icon bg-linear-to-r ${service.color} shadow-glow`}
                >
        ...
        <div className="text-center">
          <div className="bg-white/60 backdrop-blur-xs rounded-3xl p-12 shadow-elegant border border-white/20 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Transform your digital presence with our proven marketing
              strategies and data-driven approaches.
            </p>
            <Button
              size="lg"
